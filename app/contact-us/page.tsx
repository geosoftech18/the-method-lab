  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      content: 'info@methodlabacademy.com',
      link: 'mailto:info@methodlabacademy.com',
      color: 'ablr-primary',
    ...
    },
    {
      icon: Phone,
      title: 'Phone',
      content: '+91 8240338278',
      link: 'tel:+918240338278',
  ...
  const socialMedia = [
    {
      icon: Linkedin,
      name: 'LinkedIn',
      link: 'https://www.linkedin.com/in/dr-angana-nandy-28546350/',
