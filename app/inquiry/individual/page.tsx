  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative bg-white pt-8 pb-8 overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-ablr-dark/5 to-transparent"></div>
            ...
            <ScrollAnimation direction="up">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 bg-ablr-dark/10 rounded-full flex items-center justify-center">
                  <User size={32} className="text-ablr-dark" />
                </div>
                <div>
                  <p className="label-small-caps text-ablr-dark/70 mb-2 text-sm">Individual Enquiry</p>
                  <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold text-ablr-dark leading-tight">
                    Enquire (Individual)
                  </h1>
                </div>
              </div>
              <p className="text-lg text-gray-700 max-w-2xl">
                Have questions about our programmes? Fill out the form below and we'll get back to you as soon as possible.
              </p>
            </ScrollAnimation>
          </div>
        </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-ablr-dark focus:outline-none transition-colors duration-300"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-ablr-dark focus:outline-none transition-colors duration-300 bg-white"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={6}
                        className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-ablr-dark focus:outline-none transition-colors duration-300 resize-none"
                        placeholder="Please share your questions or what you'd like to know about our programmes"
                      />
                    </div>
