  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 md:col-span-6">
              <p className="text-gray-700 leading-relaxed mb-6">
                Our programmes are meticulously designed using a systematic approach that combines:
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="text-ablr-primary mt-1 flex-shrink-0" size={24} />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Evidence-Based Curriculum</h4>
                    <p className="text-gray-700 text-sm">Content grounded in the latest research and best practices</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="text-ablr-primary mt-1 flex-shrink-0" size={24} />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Practical Application</h4>
                    <p className="text-gray-700 text-sm">Hands-on exercises and real-world case studies</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="text-ablr-primary mt-1 flex-shrink-0" size={24} />
                  <div>
                    ...
                    <p className="text-gray-700 text-sm">Led by experienced practitioners and researchers</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div className=" section-spacing">
          ...
          <div className="grid grid-cols-12  justify-center">
            {programFormats.map((format, index) => {
              ...
              return (
                <div key={index} className="col-span-12 md:col-span-4 flex justify-center ">
      ...
      <ScrollAnimation direction="up" delay={600}>
        <div className="bg-gradient-to-br from-ablr-dark/80 to-ablr-dark rounded-2xl p-8 sm:p-12 text-white text-center">
          <h3 className="text-2xl sm:text-3xl font-serif font-bold mb-4">
            Ready to Get Started?
          </h3>
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Explore our programmes or get in touch to learn more about how we can support your professional development.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/programs?filter=all"
              className="px-8 py-4 bg-white text-ablr-dark rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-flex items-center justify-center gap-2"
            >
